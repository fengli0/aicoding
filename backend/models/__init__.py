...
class Shot(Base):
    ...
    continuity_source = Column(String(50), default="reference_image")  # 'prev_frame' or 'reference_image'
...
class AssetVersion(Base):
    ...
    extra_metadata = Column(JSON)  # model, workflow version, params, seed, inputs (renamed from metadata)
